...
export const BentoGridItem = ({
  ...
  const handleCopy = () => {
    navigator.clipboard.writeText('contact@beejoy3000.com');
  ...
  return (
    <div
      ...
      style={{
        ...
        backgroundColor: 'linear-gradient(90deg, rgba(2,0,36,1) 0%, rgba(59,59,68,1) 26%, rgba(93,108,111,1) 100%, rgba(0,212,255,1) 100%)'
      }}
    >
        ...
        <div className={`${id === 6 && 'flex justify-center md:mt-[-20px]'} h-full'`}>
          ...
          <div className={cn(
            ...
            <div>
              ...
              {id == 3 && (
                <div className="flex gap-1 lg:gap-3 w-fit absolute -right-3 top-3 lg:top-10 lg:right-3.5">
